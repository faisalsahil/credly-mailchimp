...
<div class="row-fluid" style="float:left;min-width:1250px;">
  <div class="hero-unit">
    <div class="well" id="templatenames" style="font-size:12px;">
      <fieldset>
       <div>
        <h3>MailChimp Email Templates</h3>

        <div style="font-size:12px;">
          You can send Credly badge notifications using your MailChimp email templates.
          Credly-enabled templates are available to you when using the "Issue Badges" area of this app. 
          Any MailChimp template can be Credly-enabled simply by inserting the badge image and badge 
          acceptance link into the email. <br/><br/>
        </div>


        <input type="submit" class="btn btn-success" id="addenabletemplate" value="Add & Enable a Template"/><br/><br/>
        <h3>Credly-enabled Templates</h3>
        <div style="font-size:12px;">

          MailChimp templates that you have already enabled for use as Credly badge notification emails.<br> 
          Add new ones using the button above.<br/><br/>
        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            if ($templates !== 0) {
              ...
              <tr>
                <form>
                  <td><?php echo $template->templatename; ?></td> 
                  <td>
                    <a id="templateedit" value="<?php echo $template->id;?>" href="<?php echo site_url('template/'); ?>/edit/?id=<?php echo $template->id;?>&name=<?php echo $template->templatename;?>" class="btn btn-mini btn-success">Edit</a> 
                    <!-- <a id="templateedit" value="<?php echo $template->id;?>"  class="btn btn-mini btn-success">edit</a> -->
                    <a id="templatedestroy" href="<?php echo site_url('template/'); ?>/destroy/?id=<?php echo $template->id;?>" class="btn  btn-mini btn-danger">Delete</a>
                  </td>
    ...
    <div class="well" id="templatedesign" style="display:none;" >
      <fieldset>
       <div>
        <h3>Enable a MailChimp Email Template</h3>
        <div style="font-size:12px;">
          <strong>You can send Credly badge notifications using your MailChimp email templates.</strong><br/>
          Credly-enabled templates are available to you when using the "Issue Badges" area<br>
           of this app. Any MailChimp template can be Credly-enabled by inserting a Credly<br>
            badge image placeholder and/or badge acceptance button or link into a MailChimp template.<br/><br/><br>
        </div>
        <table class="table table-striped">
          <tbody>
            ...
            <lable style="font-size:12px;"><b>1. Select an email template</b><br> <b>&nbsp;&nbsp;&nbsp;&nbsp;from your MailChimp account:</b></lable>
            <span style="margin-left:38px;"></span>

            <select style="font-size:12px; margin-left: 10%; margin-top: -1%;" style="margin-left: 45px;
            margin-top: -40px;" name="select_template" id="select_template" required>
            <?php
            if(isset($mctemplates)){ ?>
            <option value="0" selected="selected" >Select a Template</option>
            <?php foreach ($mctemplates['user'] as $mctemplate) {
              ?>
              <option value="<?php echo $mctemplate['id']; ?>" ><?php echo $mctemplate['name']; ?></option>
              <?php } } ?>
            </select><br>
            <lable style="font-size:12px;"><br><b>2. Enter a title for the Credly-</b><br><b>&nbsp;&nbsp;&nbsp;&nbsp;enabled version of this template:</b></lable>
            <input style=" margin-left: 12%;
            margin-top: -2%;" type="text" id="templatename" value="<?php echo $tempname; ?>"required>


          </tbody>
        </table>
        <div id="question_mark">
          <img src="..." class="icon-question-sign">
          Want to create or edit a MailChimp template? Visit the "Campaigns" area of your MailChimp<br> account and choose "My Templates".
        </div>
        <br>
        <div style="font-size:12px; margin-bottom: -60px;"> 
         <b> 3. Insert the Badge image, "Save & Share" button and link into your template. </b><br>
          &nbsp;&nbsp;&nbsp;&nbsp;Place your cursor in the email template below where you would like to insert<br>
          &nbsp;&nbsp;&nbsp;&nbsp;the badge image, link or button, and then click the respective button below. The buttons<br>
          &nbsp;&nbsp;&nbsp;&nbsp;insert elements as follows:<br><br>
          <div id="template_button">
        <img src="https://credlysites.s3.amazonaws.com/1386540116.button_small_insert_badge.png"/> Badge placeholder for the actual badge you issue<br>
         <img src="https://credlysites.s3.amazonaws.com/1386540115.button_small_insert_button.png"/> "Save & Share" call-to-action button <br>
          <img src="https://credlysites.s3.amazonaws.com/1386540115.button_small_insert_text.png"/> "Save & Share" call-to-action text link
        </div>
        <br><br>
         &nbsp;&nbsp;&nbsp;&nbsp;<strong>Note:</strong> Each of the elements above will automatically be linked to each recipient's
          unique <br>&nbsp;&nbsp;&nbsp;&nbsp;badge page when you issue badges using this template using this app.  We 
           recommend using <br>&nbsp;&nbsp;&nbsp;&nbsp;all three available options to increase the visibility of the badge
            and response to your call to action.<br>&nbsp;&nbsp;&nbsp;&nbsp; Do not edit the code we insert with these
            elements to ensure they work properly when your email is sent.
       </div>
       <br><br>
       <div style="visibility:hidden;">Remember to click "Save Template" below when done.Before you can 
         save this template, please insert the Badge and/or text link into the template using the 
         toolbar above the selected template.
       </div>
     </div>
   </fieldset>
   <div class="content">
    <?php echo link_css('widgEditor'); ?>
    <textarea id="noise" name="noise" class="widgEditor" >
      <?php echo $prehtml; ?>
    </textarea>
  </div>
  <a style="margin-left:20px;" id="btnsavetemplate" class="btn btn-success pull-right">Save</a>
  <a id="savetemplateback" class="btn btn-danger pull-right">Back</a>
</div>
...
<script type="text/javascript">
  ...
  $('#addenabletemplate').click(function(e){
  ...
  $('#savetemplateback').click(function(e){
  ...
  $('#templatedestroy').click(function(e){

    if (confirm('Are you sure you want to delete this Credly-enabled mailchimp template?')) {
  ...
  $('#select_template_ontemplatescreen').change(function(e){
    var templateid =$('#select_template_ontemplatescreen').val();

    $.ajax({
     type: "POST",
     url: baseurl+"template/gettemplateHtml",
     data: {templateid:templateid},
     success: function(data){ 
      $('#noiseWidgToolbarButtonHTML a').click();
      $('#noiseWidgTextarea').val(data);
      $('#noiseWidgToolbarButtonHTML a').click();
    },dataType: 'html'
  });
  ...
  $('#select_template').change(function(e){
    ...
    else
    {
      ...
      $.ajax({
       type: "POST",
       url: baseurl+"Integrations/sendbadge/gettemplateHtmlfromMailChimp",
       data: {templateid:templateid},
       success: function(data)
       { 
        $('#noiseWidgToolbarButtonHTML a').click();
  ...
  $('#btnsavetemplate').click(function(e){
    if ($('#templatename').val() == "")
    {
      alert("Please enter the name of the template");
      return ;
    }
    ...
    var html = $('#noiseWidgTextarea').val();
    $('#noiseWidgToolbarButtonHTML a').click(); 


    $.ajax({
      type: "POST",
      url: baseurl+"template/addupdateTemplate",
      data: {name:name,html:html},
      success: function(data){ 
        if(data==false)
        {
          alert("Error Saving Html: Please make sure that Accept Credlt Badge should be there");
        }
        else
        {
...
function widgEditor(replacedTextareaID)
{
  ...
  //this.theTextarea.style.display = "hidden";
...
function widgToolbar(theEditor)
{
  ...
  for (var i = 0; i < widgToolbarItems.length; i++)
  {
    ...
    {
      case "bold":
      this.addButton(this.theList.id + "ButtonBold", "widgButtonBold", "Insert Acceptance Button", "bold");

      break;

      case "italic":
      this.addButton(this.theList.id + "ButtonItalic", "widgButtonItalic", "Insert Save & Share Image", "italic");
      ...
      case "image":
      this.addButton(this.theList.id + "ButtonImage", "widgButtonImage", "Insert Badge Image", "image");
...
function test()
{
  ...
  alert(" I am in ");
  var theToolbar = this.theToolbar;
  alert(" I am in 2");
  //var theWidgEditor = this.widgEditorObject;
  switchMode();
  alert(" I am in 3");
    ...
    switch (this.action)
    {
      ...
      if (theImage != null && theImage != "")
      {
        ...
        if (theIframe.contentWindow.document.selection)
        {
          ...
          theRange.pasteHTML('<img alt="Save and Share" src="https://s3.amazonaws.com/credlysites/mailchimp/credly-placeholder-badge.png"/>');
        ...
        else
        {
          ...
          theImageNode.alt = "Save & Share";
          theImageNode.src = "https://s3.amazonaws.com/credlysites/mailchimp/credly-placeholder-badge.png";
      ...
      if (theImage != null && theImage != "")
      {
        ...
        if (theIframe.contentWindow.document.selection)
        {
          ...
          theRange.pasteHTML('<img alt="Save & Share" src="https://s3.amazonaws.com/credlysites/mailchimp/credly-save-and-share-button.png"/>');
        ...
        else
        {
          ...
          theImageNode.src = "https://s3.amazonaws.com/credlysites/mailchimp/credly-save-and-share-button.png";
      ...
      if (theImage != null && theImage != "")
      {
        ...
        if (theIframe.contentWindow.document.selection)
        {
          ...
          theRange = theSelection.createRange();
          theRange.collapse(false);
          theRange.pasteHTML('<a title="Save & Share" href="http://clients.chimpchamp.com/credly/acceptbadge" target="_blank">Accept Credly Badge</a>');
          break;
        }
        /* Mozilla selections */
        else
        {
          ...
          var theAnchorNode = theIframe.contentWindow.document.createElement('a');
          var linkText = document.createTextNode("Save & Share");
          theAnchorNode.appendChild(linkText);
          theAnchorNode.title = "Save & Share";
          theAnchorNode.href = "http://clients.chimpchamp.com/credly/acceptbadge";
          theAnchorNode.target="_blank"; 
          theRange.insertNode(theAnchorNode);
